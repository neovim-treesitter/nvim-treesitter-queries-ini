# nvim-treesitter-queries-ini

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-ini/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-ini/actions/workflows/validate.yml)

Neovim tree-sitter queries for **ini**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-ini",
...
- [ ] Changes are scoped to `ini` — do not include files for other languages
